...
class Tree {
	...
	public void createNode(int level, int leftData, int rightData, char data) {
		if (root == null) {
			root = new Node(level);
			root.data = data;
	...
	public void searchNode(Node node, int level, char data, int leftData, int rightData) {
		if (node == null) {
			return;
